    ...
    <div class="item-detail">
        ...
        <div class="item-detail__info">
            ...
            <div class="item-detail__icons">
                ...
                <span class="count count--like">
                    {{ $item->favorites_count ?? ($item->favoredByUsers->count() ?? 0) }}
                </span>

                <span class="icon icon--comment" aria-hidden="true">💬</span>
                <span class="count count--comment">
                    {{ $item->comments_count ?? ($item->comments->count() ?? 0) }}
                </span>
            </div>
            ...
            <section class="item-detail__section">
                ...
                <div class="section__text">
                    ...
                    <p>
                        {!! nl2br(e($item->description ?? '商品の状態は良好です。傷もありません。購入後、即発送いたします。')) !!}
                    </p>
                </div>
            </section>
            ...
            <section class="item-detail__section">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">
                        {{ $item->condition ? e($item->condition) : '良好' }}
                    </span>
                </div>
            </section>
            ...
            <section class="item-detail__section">
                <h2 class="section__title">
                    コメント（{{ $item->comments_count ?? ($item->comments->count() ?? 0) }}）
                </h2>
                    ...
                    <div class="comment">
                        <div class="comment__user">
                            ...
                            <span class="comment__name">
                                {{ e(optional($comment->user)->name ?? 'ゲスト') }}
                            </span>
                        </div>
