...
<div class="item-detail">
  ...
  <div class="item-detail__info">
    ...
    <button class="item-detail__buy" type="button">購入手続きへ</button>
    ...
    <section class="item-detail__section">
      ...
      <div class="info-row">
        ...
        <div class="info-chips">
          @php
            $parent = optional($item->category)->parent;
            $child  = optional($item->category);
          @endphp
          @if($parent && $parent->name)
            <span class="info-chip">{{ e($parent->name) }}</span>
          @endif
          @if($child && $child->name)
            <span class="info-chip">{{ e($child->name) }}</span>
          @else
